...
export const QUAD_ANSWERS = {
  ...
  qbt4: ["External Power ---------- AS REQUIRED"],
  qbt5: ["Sea\u200Bt height ---------- ADJUST"],
  qbt6: ["Rudder pedals ---------- ADJUST"],
  qbt7: ["Flight controls ---------- CHECK"],
  qbt8: ["Fire detection system ---------- TEST (FIRE 1 and FIRE 2)"],
  ...
  qbt29: ["PROBES ANTI-ICE switch ---------- CHECK, OFF"],
  qbt30: ["BOOST PUMP switch ---------- CHECK, ARM"],
  ...
  qas11b: ["AOA system \u200Btest switch ---------- CHECK"],
  ...
  qas12: ["Speed brake ---------- CHECK"],
  qas13: ["Flaps ---------- CHECK"],
  qas14: ["TRI\u200BM AID switch ---------- ON"],
  ...
  qas19g: ["Altitud\u200Be, G, spee\u200Bd, fue\u200Bl flags - AS REQUIRED"],
  qas20: ["Flight instruments ---------- CHECK"],
  qas21: ["Altimeters ---------- SET AND CHECK"],
  qas22: ["EICAS display ---------- CHECK"],
  qas23: ["landing/", "taxi light"],

  // TAXI
  qtaxi1: ["Transponder ---------- AS REQUIRED"],
  qtaxi2: ["Heading and turn and slip indicators ---------- CHECK"],

  // OVERSPEED GOVERNOR CHECK
  qogc1: ["Brakes ---------- HOLD AS REQUIRED"],
  qogc2: ["PCL ---------- IDLE"],
  qogc3: ["PMU switch ---------- OFF"],
  qogc4: ["PCL", "NP"],
  qogc5: ["PCL", "TORQUE", "NP"],
  qogc6: ["PCL ---------- IDLE"],
  qogc7: ["PMU switch ---------- NORM"],

  // BEFORE TAKEOFF
  qbto1: ["Torque"],
  qbto2: ["Speed brake ---------- RETRACTED"],
  qbto3: ["Flaps ---------- TO"],
  qbto4: ["Trim ---------- SET FOR TAKEOFF"],
  ...
  qlc3: ["PROBES ANTI-ICE switch ---------- ON"],
  qlc4: ["Nosewheel steering ---------- OFF"],
  qlc5: ["EICAS display ---------- CHECK"],

  // AFTER TAKEOFF
  qat1: ["Gear ---------- AS REQUIRED"],
  qat2: ["Flaps ---------- UP"],
  ...
  qbl5: ["FLAPS ---------- AS REQUIRED"],
  qbl6: ["Speed brake ---------- RETRACTED"],

  // FULL STOP/TAXI BACK CHECKLIST
  qfstb1: ["PROBES ANTI-ICE switch ---------- OFF"],
  qfstb2: ["Flaps ---------- TO"],
  qfstb3: ["Trim ---------- Set for Takeoff"],
  ...
  qfstb8: ["TORQUE"],
  qfstb9: ["landing/", "taxi light", "anti-coll light"],
  ...
  qal3: ["PROBES ANTI-ICE switch ---------- OFF"],
  qal4: ["Flaps ---------- UP"],
  qal5: ["T\u200Brim interrupt button ---------- DEPRESS"],
  qal6: ["Trim ---------- SET FOR TAKEOFF"],
  ...
  qesd8: ["Oxygen mask ---------- REMOVE"],
  qesd9: ["supply", "pressure", 'concentration'],
  qesd10: ["PCL ---------- IDLE >60 SECONDS, THEN OFF"],
  qesd11: ["CANOPY ---------- OPEN (AS REQUIRED)"],
  qesd12: ["EICAS"],
  qesd13: ["FDR light ---------- EXTINGUISHED"],
  ...
  qbla4: ["Oxygen hose and communication cord ---------- STOW WITH LOOP FORWARD"],
