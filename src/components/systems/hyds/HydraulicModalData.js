  ...
  items: [
    ...
    },
    {
      ...
      procedure: [
        ...
        'Push silver button in center of EMER LDG GR handle, then pull handle (approximately ¾ inch).',
        'Verify gear-position lights — expect 3 green and 3 red (inboard doors remain open).',
        'Do not attempt to raise gear — system can only be reset by maintenance on ground.',
        'Select flaps only after gear is confirmed down.',
      ],
      nwcs: [],
      landing: 'No specific minimum landing criteria.',
    },
