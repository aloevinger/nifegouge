...
const cellGraph = {
  ...
  "r5c3": {dependsOn: ["r7c5", "r6c8"], solver: ([xw, hwtw]) => inflightF(xw,hwtw), next: "r6c6", solved: false},
  ...
  "r8c9": {dependsOn: ["r4c9", "r8c8"], solver: ([tas, hwtw]) => gsF(tas, hwtw), next: "r9c6", solved: false, denominator: 20},
