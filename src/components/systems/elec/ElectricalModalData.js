...
export const ELEC_EPS = {
  ...
  items: [
    // ── 1 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments as applicable, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess the severity of the emergency and equipment lost prior to resetting or opening any circuit breaker.',
        '3C — Do not select REPEAT in a cockpit with working MFDs. This may result in loss of all MFD information in both cockpits.',
        '4N — If synchronization errors or erratic indications are detected on the ground, takeoff is not recommended.',
        '5N — If synchronization errors are detected without a loss of MFD information, do not select REPEAT on UFCP in either cockpit.',
        '6N — Front cockpit failures/erratic displays indicate IAC1 failure; rear cockpit failures/erratic displays indicate IAC2 failure.',
      ],
    ...
    // ── 2 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
      ],
      landing: 'Land as soon as PRACTICAL.',
    },
    // ── 3 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — Failure of a single MFD in basic mode will result in PFD and EICAS display only, and loss of ability to manipulate the display to the FMS MENU.',
      ],
    ...
    // ── 4 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — With the UFCP inoperative, functions not available to the pilot in the cockpit with the failed UFCP are: FMS execute, system Mag/True heading toggle, system GS/CAS/TAS HUD speed toggle, and radio tuning with UFCP.',
      ],
      landing: 'Land as soon as PRACTICAL.',
    },
    // ── 5 ─────────────────────────────────────────────────────────────────────
    ...
    // ── 6 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — If an EDM FAIL occurs prior to start and is accompanied by red X\'s in the IOAT and ITT counters, refer to High IOAT at Start >80°C.',
        '4N — If EDM FAIL warning remains displayed, the pilot will lose ability to directly monitor the engine, fuel, electrical, and hydraulic systems, and cockpit pressurization. PMU should remain online.',
        '5N — If an EDM A INOP or EDM B INOP advisory remains, suspect a data bus malfunction. Prior to flight, maintenance action is required.',
      ],
    ...
    // ── 7 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — If ADC FAIL warning remains displayed, primary airspeed, altimeter, and VSI will be inoperative. Reference backup flight instrument and AOA as necessary. TAD, aural gear warning, and transponder mode C will also be inoperative. Expect PMU STATUS caution to illuminate after landing.',
      ],
    ...
    // ── 8 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — When the EMR/NRM switch is placed in the EMR position, VHF audio will be unamplified and UHF audio will not be heard. Consider the loss of UHF audio prior to placing the EMR/NRM switch to EMR.',
      ],
    ...
    // ── 9 ─────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — During all electronic display failures, confirm indications in both cockpits (if occupied), reference alternate data sources or backup instruments, and check applicable circuit breakers.',
        '2N — "Reset" describes resetting a circuit breaker that is already open. Assess severity and equipment lost prior to resetting or opening any circuit breaker.',
        '3N — AOA computer failure will most easily be recognized by loss of AOA indication in the HUD and loss of the AOA indexer with landing gear down.',
      ],
      landing: 'Land as soon as PRACTICAL.',
    },
    // ── 10 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — The generator will remain offline if the starter is in the MANUAL position, and the starter will drain the battery in less than 10 minutes if left ON.',
        '2N — Opening the bus tie switch will reduce electrical load on the main battery by shedding the generator bus. This will permit main battery operation for at least 30 minutes.',
        '3W — OBOGS will be inoperative once the main battery is depleted or with battery failure.',
        '4N — If main battery fails, refer to Battery and Generator Failure procedure.',
        '5N — Cockpit will depressurize when power to the battery bus is lost.',
      ],
      landing: 'Land as soon as PRACTICAL.',
    },
    // ── 11 ────────────────────────────────────────────────────────────────────
    {
      ...
      landing: 'Land as soon as PRACTICAL.',
      table: {
        heading: 'Generator Bus Inoperative — Equipment Status',
        cols: ['Generator Bus Inoperative', 'Battery Bus Operative'],
        rows: [
          ['Air Conditioner', 'Battery Buses w/ Bus Tie Closed'],
          ['Gen Switch', 'Ram Air Valve'],
          ['Fuel Balance', 'OBOGS'],
          ['Side/Nav/Taxi/Test Lights', 'Clocks'],
          ['Probes Anti-Ice', 'Emergency Flaps'],
          ['Cockpit Temperature', 'ELT'],
          ['Nose Wheel Steering', 'Flight Data Recorder Maintenance'],
          ['Fire Detector #2', 'Battery'],
          ['Trim Indicator', 'Chip Detector'],
          ['Seat Adjust', 'Aileron/Elevator/Rudder Trim'],
          ['DVR/DTS', 'Utility/Collision/Instrument/Landing/Flood Lights'],
          ['EDMA', 'IAC1'],
          ['HOTAS', 'Ignition'],
          ['TAD', 'Avionics Master'],
          ['Speed Brake', 'Prop Sys Solenoid'],
          ['Evaporator Blower', 'Hydraulic System'],
          ['ADC', 'Fuel Quantity Low'],
          ['TCAS', 'Start'],
          ['COM1', 'UFCP'],
          ['IAC2', 'Landing Gear Control'],
          ['IRS', 'PMU FAIL and PMU STATUS Monitoring'],
          ['Radio Relays', 'Oil TRX'],
          ['RAD ALTM', 'Flap Control'],
          ['LH MFD', 'Angle of Attack'],
          ['DME', 'Boost Pump'],
          ['Transponder', 'EDM B'],
          ['VHF NAV', 'Battery Switch'],
          ['', 'Inflow Switch'],
          ['', 'RH MFD'],
          ['', 'Center MFD'],
    ...
    // ── 12 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — With a battery bus failure, the PFD will be the default display in flight and the EICAS and NAV displays can be accessed using the MFD menu page.',
        '2N — If the BAT BUS warning illuminates, the cockpit battery bus has failed or the annunciator sensing circuit has failed. The generator is still supplying the generator bus and charging the battery.',
        '3W — OBOGS will be inoperative once the main battery is depleted or with battery failure.',
        '4N — Cockpit will depressurize when power to the battery bus is lost.',
        '5N — Place the BUS TIE switch to OPEN to isolate the generator bus from any potential battery or battery bus faults.',
        '6N — Backup flight instrument and VHF tuning (standby VHF control head) will be powered for approximately 30 minutes by the auxiliary battery.',
        '7W — Plan to extend the landing gear using the emergency extension system. Emergency flaps will be powered by the main battery through the hot battery bus as long as the main battery has not failed. With normal flap extension and a loss of power to the battery bus, flaps will retract. Landing gear and flap position indicators will not be powered.',
      ],
      landing: 'Execute Landing Gear Emergency Extension prior to landing.',
      table: {
        heading: 'Battery Bus Inoperative — Equipment Status',
        cols: ['Battery Bus Inoperative', 'Generator Bus Operative'],
        rows: [
          ['Battery Buses w/ Bus Tie Closed', 'Air Conditioner'],
          ['Ram Air Valve', 'Gen Switch'],
          ['OBOGS', 'Fuel Balance'],
          ['Clocks', 'Side/Nav/Taxi/Test Lights'],
          ['Emergency Flaps', 'Probes Anti-Ice'],
          ['ELT', 'Cockpit Temperature'],
          ['Flight Data Recorder Maintenance', 'Fire Detector #2'],
          ['Battery', 'Seat Adjust'],
          ['Chip Detector', 'DTS/DVR'],
          ['Nose Wheel Steering', 'EDM A'],
          ['Aileron/Elevator/Rudder Trim', 'HOTAS'],
          ['Utility/Collision/Instrument/Landing/Flood Lights', 'TAD'],
          ['IAC1', 'Speed Brake'],
          ['Ignition', 'Evaporator Blower'],
          ['Prop Sys Solenoid', 'ADC'],
          ['Avionics Master Fails in the ON Position', ''],
          ['Hydraulic System', ''],
          ['Fuel Quantity Low', 'TCAS'],
          ['Start', 'COM1'],
          ['UFCP', 'IAC2'],
          ['Landing Gear Control', 'IRS'],
          ['PMU FAIL and PMU STATUS Monitoring', 'Radio Relays'],
          ['Oil TRX', 'RAD ALTM'],
          ['Flap Control', 'LH MFD'],
          ['Angle of Attack', 'DME'],
          ...
          ['Ground Idle', 'COM2 if STBY VHF is ON'],
    ...
    // ── 13 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — With bus tie inoperative, battery and generator buses are isolated. Battery bus items draw from battery only; generator bus items draw from generator only.',
        '2N — Generator will continue to charge battery if voltage differential allows, but bus cross-feeding is lost.',
        '3N — Monitor battery voltage — if bus tie cannot be restored, battery life is limited.',
      ],
    ...
    // ── 14 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1W — Under varying conditions of fire and/or smoke where aircraft control is jeopardized, the pilot has the option of actuating CFS or ejecting.',
        '2N — Expect approximately 30 minutes of useful power from the main battery under these conditions. Items on the generator bus will remain powered as long as the generator is online. To conserve battery power, consider deactivating interior/exterior lighting as conditions permit. The avionics master switch can also be set to OFF, disabling all avionics and radios, except the standby VHF.',
        '3N — If main battery depletes, refer to Battery Bus Inoperative procedure. Items on generator bus will remain functional with an operative generator.',
      ],
    ...
    // ── 15 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1W — Under varying conditions of fire and/or smoke where aircraft control is jeopardized, the pilot has the option of actuating CFS or ejecting.',
        '2N — If a faulty component can be identified as the source of smoke and fumes, turn defective unit off or pull respective circuit breaker. Circuit breakers for items on the hot battery bus are not accessible in flight.',
        '3N — Selecting RAM/DUMP does not shut off bleed air inflow.',
        '4N — Defog is turned off when RAM/DUMP is selected.',
        '5W — OBOGS will be inoperative once the main battery is depleted or with battery failure.',
        '6W — To prevent injury, ensure oxygen mask is on and visor is down prior to actuating the CFS system.',
        '7N — Recover aircraft without electrical power if possible. If IMC penetration is required, turn the auxiliary battery on. Backup flight instruments and lighting, fire detection (FIRE 1 only), and VHF radio (tuning through standby VHF control unit) will be powered for approximately 30 minutes. Landing gear must be extended by emergency means. The flap lever is powered through the hot battery bus and should function as long as the main battery has not depleted. With normal flap extension and a loss of power to the battery bus, flaps will retract. Gear and flap indicators, as well as exterior lighting, will not be powered. Unless the faulty component has been isolated, further restoration of electrical power is not recommended.',
        '8N — With the battery and generator off, the landing gear must be extended using the emergency landing gear extension system.',
      ],
      landing: 'Land as soon as POSSIBLE.',
    },
    // ── 16 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — An amber IAC XTALK message may result in loss of repeat switch functionality. RPT ERROR will be posted if MFD/UFP REPEAT/NORM switch is in REPEAT. Baro Set function, heading, altitude and airspeed bug settings, minimums on/off selection, radio altitude set height, mag/true compass setting, bingo fuel setting, clock setting, and G reset feature will operate independently in each cockpit.',
        '2C — With IAC XTALK message present, Baro Set function on the UFCP will operate independently in each cockpit. Confirm PFD altimeter settings in each cockpit.',
      ],
      landing: 'No specific landing criteria.',
    },
    // ── 17 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — Although direct effects of the ADS-B failure are minor, the ADS-B information will be used by other ADS-B-equipped aircraft and by ATC. Confirm with ATC that ADS-B information is not being transmitted or is transmitting in error. If ADS-B is transmitting in error, disable by turning the transponder to standby. With the transponder placed in standby, all transponder-related functions will be lost (mode C, S, TCAS, ADS-B).',
      ],
      landing: 'No specific landing criteria.',
    },
    // ── 18 ────────────────────────────────────────────────────────────────────
    {
      ...
      nwcs: [
        '1N — Although direct effects of the transponder failure are minor, the transmitted information will be used by other TCAS- and ADS-B-equipped aircraft and by ATC. Confirm with ATC that information is not being transmitted or is transmitting in error. If transmitting in error, disable by turning the transponder to standby. With the transponder in standby, all transponder-related functions will be lost (mode C, S, TCAS, ADS-B).',
      ],
      landing: 'No specific landing criteria.',
    },
  ],
